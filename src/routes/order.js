...
router.get('/api/order', order.getDataorder);

// GET localhost:8080/order/2 => Ambil data semua order berdasarkan id = 2
router.get('/api/order/:id', order.getDataorderByID);

// POST localhost:8080/order/add => Tambah data order ke database
router.post('/api/order/add', order.addDataorder);

// POST localhost:8080/order/2 => Edit data order
router.post('/api/order/edit', order.editDataorder);

// POST localhost:8080/order/delete => Delete data order
router.post('/api/order/delete/', order.deleteDataorder);
